package pe.edu.upeu.ahc.examen;
...
public class ResolucionExamen {
    ...
    public void problema2() {
        ...
        nPartida = LeerTeclado.lector(0);
        System.out.println("Ingresa el numero de llegada: ");
        nLlegada = LeerTeclado.lector(0);
    ...
    public int problema4(int n, int e) {
        if (e <= 0) {
            return 1;
        } else {
            return n * problema4(n, e - 1);
        }
    }
